...
```
Clone https://github.com/nantas/superpowers to ~/.config/opencode/superpowers, then create directory ~/.config/opencode/plugins, then symlink ~/.config/opencode/superpowers/.opencode/plugins/superpowers.js to ~/.config/opencode/plugins/superpowers.js, then symlink ~/.config/opencode/superpowers/skills to ~/.config/opencode/skills/superpowers, then restart opencode.
```
...
git clone https://github.com/nantas/superpowers.git "%USERPROFILE%\.config\opencode\superpowers"
...
```powershell
# 1. Install Superpowers
git clone https://github.com/nantas/superpowers.git "$env:USERPROFILE\.config\opencode\superpowers"
